...
HD_PWD='/home/steve/Graduate_Research/MLP/build/Pynq-Z1-pynqZ1/_sds/p0/vivado/prj/prj.runs/bare_MLP_1_if_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bare_MLP_1_if_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bare_MLP_1_if_0.tcl
