...
HD_PWD='/home/steve/Graduate_Research/MLP/build/Pynq-Z1-pynqZ1/_sds/p0/vivado/prj/prj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bare_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bare_wrapper.tcl -notrace
