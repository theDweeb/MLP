set moduleName read_from_ddr_1
...
set C_modelName {read_from_ddr.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_r int 8 regular {fifo 0 volatile }  }
	{ buffer_r int 8 regular {array 1000 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"InputProcess" : [
			{"ID" : "1", "Name" : "read_from_ddr_1_Loop_U0"}],
		"OutputProcess" : [
			{"ID" : "1", "Name" : "read_from_ddr_1_Loop_U0"}],
		"Port" : [
			{"Name" : "input_r", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "read_from_ddr_1_Loop_U0", "Port" : "input_r"}]},
			{"Name" : "buffer_r", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "read_from_ddr_1_Loop_U0", "Port" : "buffer_r"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.read_from_ddr_1_Loop_U0", "Parent" : "0",
