...
set C_modelName {read_from_ddr}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_r int 8 regular {fifo 0 volatile }  }
	{ buffer_r int 8 regular {array 10 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"InputProcess" : [
			{"ID" : "1", "Name" : "read_from_ddr_Loop_1_U0"}],
		"OutputProcess" : [
			{"ID" : "1", "Name" : "read_from_ddr_Loop_1_U0"}],
		"Port" : [
			{"Name" : "input_r", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "read_from_ddr_Loop_1_U0", "Port" : "input_r"}]},
			{"Name" : "buffer_r", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "read_from_ddr_Loop_1_U0", "Port" : "buffer_r"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.read_from_ddr_Loop_1_U0", "Parent" : "0",
...
set Spec2ImplPortList { 
	...
	buffer_r { ap_memory {  { buffer_r_address0 mem_address 1 4 }  { buffer_r_ce0 mem_ce 1 1 }  { buffer_r_d0 mem_din 1 8 }  { buffer_r_q0 mem_dout 0 8 }  { buffer_r_we0 mem_we 1 1 }  { buffer_r_address1 mem_address 1 4 }  { buffer_r_ce1 mem_ce 1 1 }  { buffer_r_d1 mem_din 1 8 }  { buffer_r_q1 mem_dout 0 8 }  { buffer_r_we1 mem_we 1 1 } } }
}
